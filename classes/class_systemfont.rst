...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/SystemFont.xml.
...
.. table::
   ...
   +---------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+-------------------------+
   | :ref:`FontLCDSubpixelLayout<enum_TextServer_FontLCDSubpixelLayout>` | :ref:`lcd_subpixel_layout<class_SystemFont_property_lcd_subpixel_layout>`                               | ``1``                   |
   +---------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------+-------------------------+
...
.. _class_SystemFont_property_lcd_subpixel_layout:

.. rst-class:: classref-property

:ref:`FontLCDSubpixelLayout<enum_TextServer_FontLCDSubpixelLayout>` **lcd_subpixel_layout** = ``1`` :ref:`🔗<class_SystemFont_property_lcd_subpixel_layout>`
