...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/CheckButton.xml.
...
.. table::
   ...
   +-----------------------------------+----------------------------------------------------------------------------------------------+-----------------------------------+
   | :ref:`Color<class_Color>`         | :ref:`button_checked_color<class_CheckButton_theme_color_button_checked_color>`              | ``Color(0.226, 0.478, 0.921, 1)`` |
   +-----------------------------------+----------------------------------------------------------------------------------------------+-----------------------------------+
   | :ref:`Color<class_Color>`         | :ref:`button_unchecked_color<class_CheckButton_theme_color_button_unchecked_color>`          | ``Color(0.875, 0.875, 0.875, 1)`` |
   +-----------------------------------+----------------------------------------------------------------------------------------------+-----------------------------------+
...
:ref:`Color<class_Color>` **button_checked_color** = ``Color(0.226, 0.478, 0.921, 1)`` :ref:`🔗<class_CheckButton_theme_color_button_checked_color>`
...
:ref:`Color<class_Color>` **button_unchecked_color** = ``Color(0.875, 0.875, 0.875, 1)`` :ref:`🔗<class_CheckButton_theme_color_button_unchecked_color>`
