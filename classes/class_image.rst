...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/Image.xml.
...
.. table::
   ...
   +----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |bitfield|\[:ref:`PNGFlags<enum_Image_PNGFlags>`\] | :ref:`get_png_flags<class_Image_method_get_png_flags>`\ (\ ) |const|                                                                                                                                                                                                               |
   +----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                                             | :ref:`set_png_flags<class_Image_method_set_png_flags>`\ (\ flags\: |bitfield|\[:ref:`PNGFlags<enum_Image_PNGFlags>`\]\ )                                                                                                                                                           |
   +----------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _enum_Image_PNGFlags:

.. rst-class:: classref-enumeration

flags **PNGFlags**: :ref:`🔗<enum_Image_PNGFlags>`

.. _class_Image_constant_PNG_FLAG_NOT_SRGB:

.. rst-class:: classref-enumeration-constant

:ref:`PNGFlags<enum_Image_PNGFlags>` **PNG_FLAG_NOT_SRGB** = ``1``
...
.. _class_Image_constant_PNG_FLAG_FAST:

.. rst-class:: classref-enumeration-constant

:ref:`PNGFlags<enum_Image_PNGFlags>` **PNG_FLAG_FAST** = ``2``
...
.. _class_Image_method_get_png_flags:

.. rst-class:: classref-method

|bitfield|\[:ref:`PNGFlags<enum_Image_PNGFlags>`\] **get_png_flags**\ (\ ) |const| :ref:`🔗<class_Image_method_get_png_flags>`
...
.. _class_Image_method_set_png_flags:

.. rst-class:: classref-method

|void| **set_png_flags**\ (\ flags\: |bitfield|\[:ref:`PNGFlags<enum_Image_PNGFlags>`\]\ ) :ref:`🔗<class_Image_method_set_png_flags>`

Set the PNG flags used when saving the image to PNG. Defaults to :ref:`PNG_FLAG_FAST<class_Image_constant_PNG_FLAG_FAST>`.
