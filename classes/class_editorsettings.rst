...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/EditorSettings.xml.
...
.. table::
   ...
   +---------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`bool<class_bool>`                           | :ref:`editors/game/embedded_game<class_EditorSettings_property_editors/game/embedded_game>`                                                                                                                       |
   +---------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +---------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`bool<class_bool>`                           | :ref:`interface/editor/thick_scrollbars<class_EditorSettings_property_interface/editor/thick_scrollbars>`                                                                                                         |
   +---------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _class_EditorSettings_property_editors/game/embedded_game:

.. rst-class:: classref-property

:ref:`bool<class_bool>` **editors/game/embedded_game** :ref:`🔗<class_EditorSettings_property_editors/game/embedded_game>`
...
.. _class_EditorSettings_property_interface/editor/thick_scrollbars:

.. rst-class:: classref-property

:ref:`bool<class_bool>` **interface/editor/thick_scrollbars** :ref:`🔗<class_EditorSettings_property_interface/editor/thick_scrollbars>`

If ``true``, editor will utilize thicker scrollbars.

\ **Note:** This setting will be ignored if :ref:`interface/touchscreen/increase_scrollbar_touch_area<class_EditorSettings_property_interface/touchscreen/increase_scrollbar_touch_area>` is ``true``.
