...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/modules/blazium_sdk/doc_classes/LobbyClient.xml.
...
2. Connect to the server using :ref:`connect_to_server()<class_LobbyClient_method_connect_to_server>` method.

3. Call any other methods to create, view or join lobbies, as well as add data to them.

4. Close the session using :ref:`disconnect_from_server()<class_LobbyClient_method_disconnect_from_server>` method at the end of the game.
...
.. table::
   ...
   +----------------------------------------------------------------+----------------------------------------------------------------------------------------+---------------------------------------+
   | :ref:`String<class_String>`                                    | :ref:`discord_embedded_app/path<class_LobbyClient_property_discord_embedded_app/path>` | ``"blazium/lobby/connect"``           |
   +----------------------------------------------------------------+----------------------------------------------------------------------------------------+---------------------------------------+
...
.. table::
   ...
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`LobbyResponse<class_LobbyResponse>`         | :ref:`connect_to_server<class_LobbyClient_method_connect_to_server>`\ (\ )                                                                                                                                                                                                     |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`LobbyResponse<class_LobbyResponse>`         | :ref:`disconnect_from_server<class_LobbyClient_method_disconnect_from_server>`\ (\ )                                                                                                                                                                                           |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`ViewLobbyResponse<class_ViewLobbyResponse>` | :ref:`quick_join<class_LobbyClient_method_quick_join>`\ (\ title\: :ref:`String<class_String>`, tags\: :ref:`Dictionary<class_Dictionary>` = {}, max_players\: :ref:`int<class_int>` = 4\ )                                                                                    |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`LobbyResponse<class_LobbyResponse>`         | :ref:`send_chat_message<class_LobbyClient_method_send_chat_message>`\ (\ chat_message\: :ref:`String<class_String>`, chat_metadata\: :ref:`Dictionary<class_Dictionary>` = {}\ )                                                                                               |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`ViewLobbyResponse<class_ViewLobbyResponse>` | :ref:`set_max_players<class_LobbyClient_method_set_max_players>`\ (\ max_players\: :ref:`int<class_int>`\ )                                                                                                                                                                    |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`ViewLobbyResponse<class_ViewLobbyResponse>` | :ref:`set_password<class_LobbyClient_method_set_password>`\ (\ password\: :ref:`String<class_String>` = ""\ )                                                                                                                                                                  |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`ViewLobbyResponse<class_ViewLobbyResponse>` | :ref:`set_title<class_LobbyClient_method_set_title>`\ (\ title\: :ref:`String<class_String>`\ )                                                                                                                                                                                |
   +---------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _class_LobbyClient_signal_connected_to_server:

.. rst-class:: classref-signal

**connected_to_server**\ (\ peer\: :ref:`LobbyPeer<class_LobbyPeer>`, reconnection_token\: :ref:`String<class_String>`\ ) :ref:`🔗<class_LobbyClient_signal_connected_to_server>`
...
.. _class_LobbyClient_signal_disconnected_from_server:

.. rst-class:: classref-signal

**disconnected_from_server**\ (\ reason\: :ref:`String<class_String>`\ ) :ref:`🔗<class_LobbyClient_signal_disconnected_from_server>`
...
.. _class_LobbyClient_signal_lobby_hosted:

.. rst-class:: classref-signal

**lobby_hosted**\ (\ host\: :ref:`LobbyPeer<class_LobbyPeer>`\ ) :ref:`🔗<class_LobbyClient_signal_lobby_hosted>`
...
.. _class_LobbyClient_signal_lobby_passworded:

.. rst-class:: classref-signal

**lobby_passworded**\ (\ password_protected\: :ref:`bool<class_bool>`\ ) :ref:`🔗<class_LobbyClient_signal_lobby_passworded>`
...
.. _class_LobbyClient_signal_lobby_resized:

.. rst-class:: classref-signal

**lobby_resized**\ (\ max_players\: :ref:`int<class_int>`\ ) :ref:`🔗<class_LobbyClient_signal_lobby_resized>`
...
.. _class_LobbyClient_signal_lobby_titled:

.. rst-class:: classref-signal

**lobby_titled**\ (\ title\: :ref:`String<class_String>`\ ) :ref:`🔗<class_LobbyClient_signal_lobby_titled>`
...
**peer_messaged**\ (\ peer\: :ref:`LobbyPeer<class_LobbyPeer>`, chat_message\: :ref:`String<class_String>`, chat_metadata\: :ref:`Dictionary<class_Dictionary>`\ ) :ref:`🔗<class_LobbyClient_signal_peer_messaged>`
...
.. _class_LobbyClient_property_discord_embedded_app/path:

.. rst-class:: classref-property

:ref:`String<class_String>` **discord_embedded_app/path** = ``"blazium/lobby/connect"`` :ref:`🔗<class_LobbyClient_property_discord_embedded_app/path>`
...
For discord embedded app environment, replaces the url with `client_id.discordsays.com/.proxy/blazium/lobby/connect <wss://client_id.discordsays.com/.proxy/blazium/lobby/connect>`__ if left default, where client_id is the client id from the discord embedded app url (automatically detected).
...
Needs :ref:`connect_to_server()<class_LobbyClient_method_connect_to_server>` to be called first.
...
.. _class_LobbyClient_method_connect_to_server:

.. rst-class:: classref-method

:ref:`LobbyResponse<class_LobbyResponse>` **connect_to_server**\ (\ ) :ref:`🔗<class_LobbyClient_method_connect_to_server>`
...
Generates :ref:`connected_to_server<class_LobbyClient_signal_connected_to_server>` signal if successful.
...
.. _class_LobbyClient_method_disconnect_from_server:

.. rst-class:: classref-method

:ref:`LobbyResponse<class_LobbyResponse>` **disconnect_from_server**\ (\ ) :ref:`🔗<class_LobbyClient_method_disconnect_from_server>`

Disconnect from the lobby server.

Needs :ref:`connect_to_server()<class_LobbyClient_method_connect_to_server>` to be called first.

Generates :ref:`disconnected_from_server<class_LobbyClient_signal_disconnected_from_server>` signal.
...
.. _class_LobbyClient_method_quick_join:

.. rst-class:: classref-method

:ref:`ViewLobbyResponse<class_ViewLobbyResponse>` **quick_join**\ (\ title\: :ref:`String<class_String>`, tags\: :ref:`Dictionary<class_Dictionary>` = {}, max_players\: :ref:`int<class_int>` = 4\ ) :ref:`🔗<class_LobbyClient_method_quick_join>`
...
Generates either :ref:`lobby_joined<class_LobbyClient_signal_lobby_joined>` or :ref:`lobby_created<class_LobbyClient_signal_lobby_created>`.
...
:ref:`LobbyResponse<class_LobbyResponse>` **send_chat_message**\ (\ chat_message\: :ref:`String<class_String>`, chat_metadata\: :ref:`Dictionary<class_Dictionary>` = {}\ ) :ref:`🔗<class_LobbyClient_method_send_chat_message>`
...
.. _class_LobbyClient_method_set_max_players:

.. rst-class:: classref-method

:ref:`ViewLobbyResponse<class_ViewLobbyResponse>` **set_max_players**\ (\ max_players\: :ref:`int<class_int>`\ ) :ref:`🔗<class_LobbyClient_method_set_max_players>`
...
Generates :ref:`lobby_resized<class_LobbyClient_signal_lobby_resized>`.

.. rst-class:: classref-item-separator

----

.. _class_LobbyClient_method_set_password:

.. rst-class:: classref-method

:ref:`ViewLobbyResponse<class_ViewLobbyResponse>` **set_password**\ (\ password\: :ref:`String<class_String>` = ""\ ) :ref:`🔗<class_LobbyClient_method_set_password>`
...
Generates :ref:`lobby_passworded<class_LobbyClient_signal_lobby_passworded>`.

.. rst-class:: classref-item-separator

----

.. _class_LobbyClient_method_set_title:

.. rst-class:: classref-method

:ref:`ViewLobbyResponse<class_ViewLobbyResponse>` **set_title**\ (\ title\: :ref:`String<class_String>`\ ) :ref:`🔗<class_LobbyClient_method_set_title>`
...
Generates :ref:`lobby_titled<class_LobbyClient_signal_lobby_titled>`.
