...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/GPUParticles2D.xml.
...
.. table::
   ...
   +---------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | |void|                    | :ref:`restart_keep_seed<class_GPUParticles2D_method_restart_keep_seed>`\ (\ keep_seed\: :ref:`bool<class_bool>` = true\ )                                                                                                                                            |
   +---------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _class_GPUParticles2D_method_restart_keep_seed:

.. rst-class:: classref-method

|void| **restart_keep_seed**\ (\ keep_seed\: :ref:`bool<class_bool>` = true\ ) :ref:`🔗<class_GPUParticles2D_method_restart_keep_seed>`
