...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/CheckBox.xml.
...
.. table::
   ...
   +-----------------------------------+--------------------------------------------------------------------------------------+-----------------------------------+
   | :ref:`Color<class_Color>`         | :ref:`checkbox_checked_color<class_CheckBox_theme_color_checkbox_checked_color>`     | ``Color(0.226, 0.478, 0.921, 1)`` |
   +-----------------------------------+--------------------------------------------------------------------------------------+-----------------------------------+
   | :ref:`Color<class_Color>`         | :ref:`checkbox_unchecked_color<class_CheckBox_theme_color_checkbox_unchecked_color>` | ``Color(0.875, 0.875, 0.875, 1)`` |
   +-----------------------------------+--------------------------------------------------------------------------------------+-----------------------------------+
...
:ref:`Color<class_Color>` **checkbox_checked_color** = ``Color(0.226, 0.478, 0.921, 1)`` :ref:`🔗<class_CheckBox_theme_color_checkbox_checked_color>`
...
:ref:`Color<class_Color>` **checkbox_unchecked_color** = ``Color(0.875, 0.875, 0.875, 1)`` :ref:`🔗<class_CheckBox_theme_color_checkbox_unchecked_color>`
