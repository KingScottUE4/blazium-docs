...
.. XML source: https://github.com/blazium-games/blazium/tree/4.3/doc/classes/OS.xml.
...
.. table::
   ...
   +---------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | :ref:`String<class_String>`                       | :ref:`read_string_from_stdin2<class_OS_method_read_string_from_stdin2>`\ (\ buffer_size\: :ref:`int<class_int>`\ )                                                                                                                                                                                                                                                                          |
   +---------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Standard I/O device is a regular file. This typically occurs with redirection from a terminal, e.g. ``blazium > stdout.txt``, ``blazium < stdin.txt`` or ``godot > stdout_stderr.txt 2>&1``.
...
Standard I/O device is a FIFO/pipe. This typically occurs with pipe usage from a terminal, e.g. ``echo "Hello" | blazium``.
...
.. _class_OS_method_read_string_from_stdin2:

.. rst-class:: classref-method

:ref:`String<class_String>` **read_string_from_stdin2**\ (\ buffer_size\: :ref:`int<class_int>`\ ) :ref:`🔗<class_OS_method_read_string_from_stdin2>`
