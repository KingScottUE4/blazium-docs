...
The files in the `classes/` folder are derived from [Blazium's main source repository](https://github.com/blazium-games/blazium) and are distributed under the MIT license, with the same authors as above.
